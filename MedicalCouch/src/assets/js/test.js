...
$(document).ready(function () {
  ...
  function patientDashboard1(data) {
    window.open('patients.html')
 window.find('.token').attr('token', "lolo")
    //   $.ajax({
    //       type: 'GET',
    //       headers: {
    ...
    //               $('.siba').html('<p style="text-align:center">No records available.</p>');
